...
/**
 * Different from {@link CommandDescriptorPool} in that this class contains existing {@link CommandDescriptor} instances whereas {@link
...
public class CommandDescriptorCluster {
	...
	/**
	 * @return the {@link CommandDescriptor} for the given command name (case-insensitive), or null if couldn't be found or doesn't exist in
	 * cluster
	 */
	@Nullable
