...
public class CommandXMLInputStream extends InputStream {
	 ...
	 *
	 * @param commandName the command name (case doesn't matter). If you wish to get an operator as a descriptor, prefix it with operators/
	 * (i.e. operators/myOperator or operators/plus)
