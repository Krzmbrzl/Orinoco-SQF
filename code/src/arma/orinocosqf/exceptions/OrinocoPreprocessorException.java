...
public class OrinocoPreprocessorException extends OrinocoException {
	 ...
	 */
	public OrinocoPreprocessorException() {
		super();
	}
	 ...
	 */
	public OrinocoPreprocessorException(String message) {
		super(message);
	}
	 ...
	 */
	public OrinocoPreprocessorException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 *        and indicates that the cause is nonexistent or unknown.)
	 */
	public OrinocoPreprocessorException(Throwable cause) {
		super(cause);
	}
