...
/**
 * Base class of all custom Orinoco exceptions
 *
 * @author Raven
 */
public class OrinocoException extends Exception {
	private static final long serialVersionUID = 3321787631611557930L;
	 ...
	 */
	public OrinocoException(String message) {
		super(message);
	}
	 ...
	 */
	public OrinocoException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 * and indicates that the cause is nonexistent or unknown.)
	 */
	public OrinocoException(Throwable cause) {
		super(cause);
	}
	 ...
	 */
	protected OrinocoException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
