...
/**
 * An exception thrown whenever an invalid syntax is being encountered
 * 
 * @author Raven
 *
 */
public class InvalidSyntaxException extends OrinocoException {

	private static final long serialVersionUID = -3813002713577543861L;
	 ...
	 */
	protected InvalidSyntaxException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
