...
/**
 * Base class of all Orinoco runtime exceptions
 * 
 * @author Raven
 *
 */
public class OrinocoRuntimeException extends RuntimeException {

	private static final long serialVersionUID = -6185905040445228567L;
	 ...
	 */
	public OrinocoRuntimeException() {
		super();
	}
	 ...
	 */
	public OrinocoRuntimeException(String message) {
		super(message);
	}
	 ...
	 */
	public OrinocoRuntimeException(Throwable cause) {
		super(cause);
	}

	/**
	 * Constructs a new runtime exception with the specified cause and a detail message of {@code (cause==null ? null : cause.toString())}
	 * (which typically contains the class and detail message of {@code cause}). This constructor is useful for runtime exceptions that are
	 * little more than wrappers for other throwables.
	 *
	 * @param cause the cause (which is saved for later retrieval by the {@link #getCause()} method). (A {@code null} value is permitted,
	 *        and indicates that the cause is nonexistent or unknown.)
	 */
	public OrinocoRuntimeException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 */
	public OrinocoRuntimeException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
